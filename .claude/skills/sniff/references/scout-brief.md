# independent scout Brief Template

Use this to construct the prompt for each `independent scout` agent spawned in step 4 --
...
your own hypotheses about what is wrong -- independent scout finds independently.
...
## Return
Structured findings in the independent scout Findings format from your agent definition:
